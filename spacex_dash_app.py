...
def get_pie_chart(site_dropdown):
    if site_dropdown == 'ALL':
        ...
        pie = px.pie(data_frame = filtered_df, names='Launch Site', values='class' ,title='Total Launches for All Sites')
        return pie
    else:
        filtered_df=spacex_df.loc[spacex_df['Launch Site'] == site_dropdown]
        pie = px.pie(data_frame = filtered_df, names='class',title='Total Launch for a Specific Site')
        return pie
